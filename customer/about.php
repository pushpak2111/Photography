            ...
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="row g-3 img-twice position-relative h-100">
                        <div class="col-6">
                            <img class="img-fluid bg-light p-3" src="../User/image/pre wedding/6.jpg" alt="">
                        </div>
                        <div class="col-6 align-self-end">
                            <img class="img-fluid bg-light p-3" src="../User/image/post wedding/1.jpg" alt="">
                        </div>
                    </div>
                </div>
        ...
        <div class="row g-0">
            ...
            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                <div class="row g-1 flex-lg-row-reverse">
                    <div class="col-sm-5">
                        <div class="team-img position-relative">
                            <img class="img-fluid" src="../User/image/3.jpeg" alt="">
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="h-100 p-5 d-flex flex-column justify-content-between">
