...
?>
 ...
 <div class="container-xxl py-5">
        <div class="container">
            ...
            <h2><p class="text-primary text-uppercase mb-2">Mehndi</p></h2>
            ...
            <div class="row g-3">
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            <div class="project-item">
                                <img class="img-fluid" src="image\mehndi\6.jpg" alt="">
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="row g-3">
                        <div class="col-12">
                            <div class="project-item">
                                <img class="img-fluid" src="image\mehndi\11.jpg" alt="">
                               
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="project-item">
                                <img class="img-fluid" src="image\mehndi\4.jpg" alt="">
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="row g-3">
                        <div class="col-12">
                            <div class="project-item">
                                <img class="img-fluid" src="image\mehndi\2.jpg" alt="">
                            
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="project-item">
                                <img class="img-fluid" src="image\mehndi\5.jpg" alt="">
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="row g-3">
                        <div class="col-12">
                            <div class="project-item">
                                <img class="img-fluid" src="image\mehndi\9.jpg" alt="">
                                
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="project-item">
                                <img class="img-fluid" src="image\mehndi\8.jpg" alt="">
            ...
            <div class="row g-3">
                <div class="col-lg-3 col-md-5 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="row g-3">
                        <div class="col-12">
                            <div class="project-item">
                                <img class="img-fluid" src="image\mehndi\7.jpg" alt="">
                                
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="project-item">
                                <img class="img-fluid" src="image\mehndi\10.jpg" alt="">
