    ...
    <!-- Main content -->
	  ...
	  <div class="card">
              ...
              <table id="example1" class="table table-bordered table-striped">
				  ...
				  <?php
				   $p1=$_REQUEST['p'];
                   $select="select * from product_entry join add_category on add_category.cid = product_entry.pcid join sub_category on sub_category.sid = product_entry.pscid where product_entry.peid='$p1'";
