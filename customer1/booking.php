 ...
 <div class="container-fluid hero-header bg-light py-5 mb-5">
        <div class="container py-5">
            <div class="row g-5 align-items-center">
                <div class="col-lg-6">
                    <h1 class="display-4 mb-3 animated slideInDown">View Detail</h1>
  ...
  <div class="content-wrapper">
    ...
    <?php
        ...
        $select="select * from product_entry join sub_category on sub_category.sid=product_entry.peid join add_category on add_category.cid=sub_category.sid";
  ...
  <div class="desc"><?php echo $row['category']?>
  <?php echo $row['subcategoryname']?>-<?php echo $row ['price'] ?>Rs.<br>
  <button clsss="btn btn-primary"> <a href="book now.php?book=<?php echo $row['peid']?>&price=<?php echo $row ['price'] ?>" >Book Now</a></button><br><br>
