<?php
  ...
  {
    $a=$_REQUEST['cl_name'];
	$b=$_REQUEST['cl_gender'];
    $c=$_REQUEST['cl_num'];
    $d=$_REQUEST['ev_date'];
    $e=$_REQUEST['clemail'];
    $f=$_REQUEST['cl_address'];
    $insert="insert into user_bookclname values(null,'$a','$b','$c','$d','$e','$f')";
                ...
                <div class="col-lg-8 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <form method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <div>
                                    <label for=""><h6>Gender : </h6></label>
                                    
                                    <input type="radio" id="male" name="cl_gender" value="MALE" required>
                                    <label for="male">MALE</label>
                                    <input type="radio" id="female" name="cl_gender" value="FEMALE" required>
                                    <label for="female">FEMALE</label>
                                    <input type="radio" id="other" name="cl_gender" value="OTHER" required>
                            ...
                            <div class="col-md-12">
                                <div class="form-floating">
                                    <input type="date" class="form-control" id="dob" placeholder="Your birthdate" name="ev_date" required>
