...
<body>
                ...
                <div class="col-lg-6 animated fadeIn">
                    <div class="row g-3">
                        <div class="col-6 text-end">
                            <img class="img-fluid bg-white p-3 w-100" src="image/haldi/1.jpg" alt="">
                        </div>
                        <div class="col-6">
                            <img class="img-fluid bg-white p-3 w-100" src="image/wedding/12.jpg" alt="">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container-xxl py-5">
		...
		<input id="email1" class="form-control" style="width:200px" type="password" name="txtpwd" placeholder="Enter New password"  pattern="[A-Za-z0-9@]{6,}" required><br><br>
		</div>
