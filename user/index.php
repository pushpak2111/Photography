                ...
                <div class="col-lg-6 animated fadeIn">
                    <div class="row g-3">
                        <div class="col-6 text-end">
                            <img class="img-fluid bg-white p-3 w-100 mb-3" src="img/Niranjan + Neha.jpg" alt="">
                            <img class="img-fluid bg-white p-3 w-50" src="img/Apeksha + Yogesh 2.jpg" alt="">
                        </div>
                        <div class="col-6">
                            <img class="img-fluid bg-white p-3 w-50 mb-3" src="img/front cover.jpg" alt="">
                            <img class="img-fluid bg-white p-3 w-100" src="img/Harshad + Dipali 2.jpg" alt="">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row g-0">
                ...
                <div class="row g-0 flex-sm-row">
                    <div class="col-sm-6">
                        <div class="team-img position-relative">
                            <img class="img-fluid" src="image/1.jpeg" alt="">
                        </div>
                    </div>
                    <div class="col-sm-6">
            ...
            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.3s">
                <div class="row g-0 flex-sm-row-reverse flex-lg-row">
                    <div class="col-sm-6">
                        <div class="team-img position-relative">
                            <img class="img-fluid" src="image/2.jpeg" alt="">
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="h-100 p-5 d-flex flex-column justify-content-between">
            ...
            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                <div class="row g-1 flex-lg-row-reverse">
                    <div class="col-sm-5">
                        <div class="team-img position-relative">
                            <img class="img-fluid" style="height:450px; width:400px;"  src="image/3.jpeg" alt="">
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="h-100 p-5 d-flex flex-column justify-content-between">
            ...
            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.3s">
                <div class="row g-0 flex-sm-row-reverse">
                    <div class="col-sm-6">
                        <div class="team-img position-relative">
                            <img class="img-fluid" src="image/4.jpeg" alt="">
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="h-100 p-5 d-flex flex-column justify-content-between">
