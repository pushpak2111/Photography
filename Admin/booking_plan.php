<?php
  ...
  //$q=$_REQUEST['quantity'];
    ...
    $insert="insert into product_entry values (null,'$c','$s','$path1','$f','$t','$p','$dec')";
  ...
  if(isset($_REQUEST['del']))
  {
    ...
    header("location:booking_plan.php");
  }
  ...
  if(isset($_REQUEST['update']))
  {
    ...
    //$u3=$_REQUEST['price'];
	  ...
	  $e1=$_REQUEST['edit'];
    $update="update product_entry set image='$path1', price='$u2',description='$u4' where peid='$e1'";
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Booking Entry</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
                ...
                <div class="card-body">
                    ...
                    <!-- <div class="form-group">
				          ...
				          <!-- <div class="form-group">
				            ...
				            <input type="text" name="quantity" class="form-control" id="exampleInputEmail1" placeholder="Enter price" required pattern="[0-9 a-z A-Z]" value="<?php echo $rows['quantity']?>">
				          </div> -->
				          <div class="form-group">
                      ...
                      ?>  
                          ...
                          <label for="fullname">Destination</label>
                                                ...
                                                <div class="col-md-6">
                                                        ...
                                                        <select class="form-control" name="df_from" >
                                                        <?php
                                                        $select="select * from fromdestination";
                                                        $res=mysqli_query($conn,$select);
                                                        while($row=mysqli_fetch_array($res))
                                                        {
                                                        ?>
                                                        <option value="<?php echo $row['df_id'];?>"><?php echo $row['df_city'];?></option>
                                                        <?php 
                                                        }
                                                        ?>  
                                                        </select>	
                                                ...
                                                <div class="col-md-6">
                                                        ...
                                                        <select class="form-control" name="dt_to">
                                                        <?php
                                                        $select="select * from todestination";
                                                        $res=mysqli_query($conn,$select);
                                                        while($row=mysqli_fetch_array($res))
                                                        {
                                                        ?>
                                                        <option value="<?php echo $row['dt_id'];?>"><?php echo $row['dt_city'];?></option>
                                                        <?php 
                                                        }
                                                        ?>  
                                                        </select>
	  ...
	  <div class="card">
              <div class="card-header">
                <h3 class="card-title">Booking Entry Data Table</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
				            <?php
                      $select="select * from product_entry join sub_category on sub_category.sid = product_entry.pscid 
                      join add_category on add_category.cid = sub_category.cid join fromdestination on fromdestination.df_id = product_entry.df_from
                      join todestination on todestination.dt_id = product_entry.dt_to";
                      $res=mysqli_query($conn,$select);
                      while($row=mysqli_fetch_array($res))
                      {
                    ?>
                  <tr>
                    ...
                    <td><?php echo $row['df_city'] ?></td>
                    <td><?php echo $row['dt_city'] ?></td>
					<td>&#8377;<?php echo $row['price'] ?></td>
					<td><?php echo $row['description'] ?></td>
                    <td><a href="product_enrty.php?del=<?php echo $row['peid']?>" name="del" class="btn btn-danger" onClick="return confirm('Are you sure You want to Delete?')">Delete</a></td>
