...
<head>
  ...
  <script type="text/javascript">
	function showblood(str)
	{
		...
		abc.open('get',"customer_ajax.php?id="+str,true);
		abc.send();
                  ...
                  <div class="well bs-component">
					...
					<form class="form-horizontal" method="post">
					  ...
					  <div class="form-group">
                          <div class="col-lg-6"><b> Customer Search	</b> 
						...
						<?php
							$result=mysqli_query($conn,"select * from customer_reg");
							while($row=mysqli_fetch_array($result))
							{	
								?>	
									<option value="<?php echo $row['cid'] ?>"><?php echo $row["fname"] ?> <?php echo $row["lname"] ?></option>
								<?php
							}
						?>		
